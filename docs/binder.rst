...
We remain committed to helping states execute their plugging projects in any way we can.
...
Navigate to this `link <https://mybinder.org/v2/gh/PRIMO-optimizer/primo-codebase/main?labpath=primo%2Fdemo%2F>`_. 
...
-----------------------------------
In the JupyterLab Server that is launched, select the PRIMO - Example_Workflow.ipynb notebook and open it. You can also open PRIMO - Example_Well_Ranking.ipynb, PRIMO - Example_Project_Recommendation.ipynb, or PRIMO - Example_Project_Comparison.ipynb to explore how to use the capabilities of PRIMO independently.
