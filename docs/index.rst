...
make the best candidates for plugging utilizing available funds,
...
#. Relevant data are read into the tool (e.g., MCW records, population data, budget, P&A cost assumptions). 

#. Users specify their preferences for:

    a) Ranking wells (e.g., hydrocarbon loss, proximity to sensitive receptors)
...
External stakeholders can easily retrace why specific wells were selected for plugging utilizing funds given the available data and 
