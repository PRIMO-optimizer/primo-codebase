...
* Navigate to the `GitHub Repository <https://github.com/PRIMO-optimizer/primo-codebase>`_. 
...
* Navigate to "primo/demo" folder and open "PRIMO - Example_Workflow.ipynb" by clicking on it. You can also open "PRIMO - Example_Well_Ranking.ipynb", "PRIMO - Example_Project_Recommendation.ipynb", or "PRIMO - Example_Project_Comparison.ipynb" to explore how to use the capabilities of PRIMO independently. An example for running the "PRIMO - Example_Workflow.ipynb" notebook is shown below.
...
* The Notebook takes a few minutes to execute. On successful execution, a new file "Primo_Example_Workflow_Projects.xlsx" will be generated in the "primo\\demo\\Example_output" folder. PRIMO is now successfully installed and configured on your machine.
...
the `US Census API <https://api.census.gov/data/key_signup.html>`_ .
