...
def process_notebook_with_config(
    ...
    """
    Process a Jupyter Notebook with a given configuration file and generate an HTML
    file of the Notebook and the Excel file that the notebook generates.
    ...
    """
    # Read the notebook
    # The as_version=4 parameter specifies that the notebook should be read
    # using the version 4 of the Jupyter Notebook format.
